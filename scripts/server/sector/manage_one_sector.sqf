...
//		if ( ( [_sectorpos, _local_capture_size] call F_sectorOwnership == WEST ) && ( GRLIB_endgame == 0 ) && (_taskNameCapture in GRLIB_tasksCompleted)) then {
